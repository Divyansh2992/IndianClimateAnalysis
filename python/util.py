...
DEFAULT_CHART_CONFIG_FILE = resource_path("default_chart_config.json")
ASHRAE_CHART_CONFIG_FILE = resource_path("ashrae_chart_style.json")
ASHRAE_IP_CHART_CONFIG_FILE = resource_path("ashrae_ip_chart_style.json")
INTERIOR_CHART_CONFIG_FILE = resource_path("interior_chart_style.json")
MINIMAL_CHART_CONFIG_FILE = resource_path("minimal_chart_style.json")
DEFAULT_ZONES_FILE = resource_path("default_comfort_zones.json")
...
def _load_config(
    ...
    if default_config_file is not None:
        ...
        config_path = os.path.join(base_dir, default_config_file)
