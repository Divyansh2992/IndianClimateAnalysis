...
exports.getEpwSummary = async (req, res) => {
    ...
    try {
        ...
        console.error('Error downloading EPW file:', err);
        return res.status(404).json({ error: 'EPW file could not be downloaded' });
    }
    console.log('Successfully downloaded EPW file');
    ...
    try {
        ...
        const scriptPath = path.join(__dirname, '..', '..', 'python', 'psychrolib.py');
